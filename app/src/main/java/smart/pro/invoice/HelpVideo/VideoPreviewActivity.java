...
import com.lisa.stories.app.AndExoPlayerView;
import com.lisa.stories.app.AppConfig;
import com.lisa.stories.app.BaseActivity;
import com.lisa.stories.app.utils.PathUtil;
import com.lisa.stories.app.utils.PublicFunctions;
import com.lisa.stories.export.Export;
import com.lisa.stories.export.MyExportFragment;
...
public class VideoPreviewActivity extends BaseActivity implements VideoPlayerListener {
    ...
    protected void startDemo() {
        ...
        andExoPlayerView.setParamsActivity((ArrayList<Export>) getIntent().getSerializableExtra("data"),
    ...
    public void onShareClick(String url, String status, String name) {
        if (!AppConfig.isConnectingToInternet(VideoPreviewActivity.this)) {
            Toast.makeText(getApplicationContext(), getString(R.string.connectInternet), Toast.LENGTH_LONG).show();
            ...
            ShareCompat.IntentBuilder.from(VideoPreviewActivity.this)
                    .setStream(videoURI)
                    .setType("video/mp4")
