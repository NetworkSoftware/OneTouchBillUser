...
public class Mainbean implements Serializable {
    ...
    public  ArrayList<StoreMainbean> storeMainbeans;
    ...
    public Mainbean(String sellername, String selleraddress, String sellerphone, String sellergstNo,
                    ...
                    String customerid,String includegst,ArrayList<Particularbean> particularbeans,ArrayList<StoreMainbean> storeMainbeans) {
        ...
        this.storeMainbeans=storeMainbeans;
    }
    ...
    public Mainbean(int id, String sellername, String selleraddress, String sellerphone,
                    ...
                    String customerid,
                    String includegst,
                    ArrayList<Particularbean> particularbeans,ArrayList<StoreMainbean> storeMainbeans) {
        this.id = id;
        this.sellername = sellername;
        this.selleraddress = selleraddress;
        this.sellerphone = sellerphone;
    ...
    public ArrayList<StoreMainbean> getStoreMainbeans() {
        return storeMainbeans;
    }

    public void setStoreMainbeans(ArrayList<StoreMainbean> storeMainbeans) {
        this.storeMainbeans = storeMainbeans;
    }
}