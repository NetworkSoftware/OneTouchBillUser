...
import smart.pro.pattasukadai.help_video.HelpVideosActivity;
...
public class SettingsActivity extends BaseActivity {
    ...
    protected void startDemo() {
        ...
        termsCheckBox.setChecked(sharedpreferences.getBoolean(serialNo, false));
        ((CheckBox) findViewById(R.id.termsCheckBox)).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putBoolean(serialNo, isChecked);
